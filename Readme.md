...
Класс CustomTask также предоставляет методы для архивирования задачи, фильтрации задач по различным критериям, таким как приоритет, состояние, дата начала и окончания.
